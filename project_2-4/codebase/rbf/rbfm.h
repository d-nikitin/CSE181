...
private:
  ...
  static bool conditionCheck(int data_integer, CompOp compOp, const void *value);
  static bool conditionCheck(float data_real, CompOp compOp, const void *value);
  static bool conditionCheck(void *data_string, CompOp compOp, const void *value, unsigned compareLength);
  unsigned findInsertPage(FileHandle &fileHandle, unsigned recordLength);
